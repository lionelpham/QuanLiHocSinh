...
<body class="gray-bg">
    ...
    <div class="middle-box text-center loginscreen   animated fadeInDown">
        <div>
            <div>
                <h1 class="logo-name" style="margin-left: -62px;">VT</h1>
            </div>
            <h3>Welcome</h3>
            <p>Register</p>
            <form method="POST" class="m-t" role="form"  action="/user-register">
            ...
            <p class="m-t"> <small>VT&copy; <a href="">VT team</a> {{date('Y')}}</small> </p>
        </div>
    </div>
